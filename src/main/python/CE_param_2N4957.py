...
PATH = "2N4957/Y-parameters/CE/data/"
...
def Y_CE_parameters_fitted():
    from fitted_functions import gie, bie, gfe, bfe, goe, boe, gre, bre

    f1 = Y_CE_parameters()[0]
    f2 = Y_CE_parameters()[2]
    f3 = Y_CE_parameters()[4]
    f4 = Y_CE_parameters()[6]
    f5 = Y_CE_parameters()[8]
    f6 = Y_CE_parameters()[10]
    f7 = Y_CE_parameters()[12]
    f8 = Y_CE_parameters()[14]
    return (f1, gie, f2, bie, f3, gfe, f4, bfe, f5, goe, f6, boe, f7, gre, f8, bre)
...
# visualize_CE_plot(f1, gie, f2, bie, f3, gfe, f4, bfe, f5, goe, f6, boe, f7, gre, f8, bre)
