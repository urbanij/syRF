...
# 
# NOTE:
# THIS FILE IS COPIED FROM aux/ FOLDER, THEN ONLY CHANGE IS IN THE REPRESENTATION OF THE OUTPUT,
# HERE I'VE REMOVED THE BOLD VERSION OF THE RESULTS.
#
...
class ReactiveComponent:
    ...
    def __repr__(self):
        ...
        rv += f"\n\t{self._component_type} = {self._component_value}  (@ {self._frequency})" if self._frequency != None else ""
        return rv
