...
from pyui.integrated_matching_ui import Ui_MainWindow # main ui window autogenerated by PyQt
...
class mainProgram(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.Rs_input.editingFinished.connect(self.calculate_integrated_matching_button.click)
        self.ft_input.editingFinished.connect(self.calculate_integrated_matching_button.click)
        self.Ic_input.editingFinished.connect(self.calculate_integrated_matching_button.click)
        self.Vt_input.editingFinished.connect(self.calculate_integrated_matching_button.click)
        self.f0_input.editingFinished.connect(self.calculate_integrated_matching_button.click)
        
        self.Lb_vs_Ic_button.clicked.connect(self.plot_Lb_vs_Ic)

        self.calculate_integrated_matching_button.clicked.connect(self.calculate_integrated_matching)
        self.clean_integrated_matching_button.clicked.connect(self.clean_integrated_matching)
    ...
    def plot_Lb_vs_Ic(self):
        ...
        try:
            ...
            color = 'tab:blue'
            ax2.set_ylabel('$L_E$', color=color)  # we already handled the x-label with ax1
