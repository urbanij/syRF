...
from syRF_ui import Ui_MainWindow # main ui window autogenerated by Qt

import rect2polar                # ui window
...
import requests                  # check for updates
...
class mainProgram(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.open_lambda4_button.clicked.connect(self.open_lambda4)
