...
from pyui.new_update_ui import Ui_MainWindow  # main ui window autogenerated by PyQt
...
REMOTE_CHANGELOG_URL = (
    "https://raw.githubusercontent.com/urbanij/syRF/master/.CHANGELOG"
)
...
class mainProgram(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.label2.setText(
            "syRF {} is now available — you have {}. Would you like to download it now?".format(
                check_update.get_remote_version(), check_update.get_version()
            )
        )
        self.label3.setText(TEXT3)

        NOTES = "<font><b>Version {}</b><br><br>".format(
            check_update.get_remote_version()
        )
